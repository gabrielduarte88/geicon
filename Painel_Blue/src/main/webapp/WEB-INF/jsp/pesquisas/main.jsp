...
<tmpl:script>
    ...
    <script>
        var alvo = $('#listaPesquisas');

        var lista = new List({
            'url': '${contextPath}/pesquisas',
            'method': 'POST',
        ...
        function inicializarLista() {
            $('#btnNovo').click(function () {
                location.href = '${contextPath}/pesquisas/novo';
            });
            ...
            $('a.visualizar', alvo).click(function () {
                ...
                location.href = '${contextPath}/pesquisas/' + ref;
                return false;
            });
...
<tmpl:dashboard title="${title} - ${instituicao.nome}">
    <div class="centro">
        <div class="centro-container">
            <h1>Pesquisas</h1>
            <p>Gerenciamento das pesquisas do sistema.</p>
            <div id="listaPesquisas" class="box"></div>
        </div>
    </div>
</tmpl:dashboard>