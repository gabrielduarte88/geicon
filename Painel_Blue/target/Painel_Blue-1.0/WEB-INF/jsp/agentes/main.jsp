...
<tmpl:script>
    ...
    <script>
        var alvo = $('#listaAgentes');

        var lista = new List({
            'url': '${contextPath}/agentes',
            'method': 'POST',
        ...
        function inicializarLista() {
            $('#btnNovo').click(function () {
                location.href = '${contextPath}/agentes/novo';
            });
            ...
            $('a.visualizar', alvo).click(function () {
                ...
                location.href = '${contextPath}/agentes/' + ref;
                return false;
            });

            $('button.documentos', alvo).click(function () {
                var ref = $(this).attr('ref');
                location.href = '${contextPath}/agentes/' + ref + '/documentos';
                return false;
            });
    ...
    <div class="centro">
        <div class="centro-container">
            ...
            <c:if test="${usuarioAtual.administrador}">
                <p><a href="${contextPath}/pesquisas/${pesquisaAtual.code}">Pesquisa "${pesquisaAtual.nome}"</a> &raquo; Gerenciamento dos agentes.</p>
            </c:if>
            <c:if test="${!usuarioAtual.administrador}">
                <p>Pesquisa "${pesquisaAtual.nome}" &raquo; Gerenciamento dos agentes.</p>
            </c:if>
            <div id="listaAgentes" class="box"></div>
        </div>
    </div>
</tmpl:dashboard>